...
{
    public partial class frmReporteDescunetosZapatos : Form
    {
        Datos.Conexiondbo conexion = new Datos.Conexiondbo();
        public frmReporteDescunetosZapatos()
        {
            InitializeComponent();
        }

        private void frmReporteDescunetosZapatos_Load(object sender, EventArgs e)
        {
        ...
        private void ConsultarAgentesRetirados(DateTime f1, DateTime f2)
        {
            ...
            try
            {
                ...
                comando.CommandText = "sp_Reporte_descunetos_zapatos  @f_inicio,@f_fin";
