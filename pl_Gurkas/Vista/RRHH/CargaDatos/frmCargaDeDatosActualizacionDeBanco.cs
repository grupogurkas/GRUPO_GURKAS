...
{
    public partial class frmCargaDeDatosActualizacionDeBanco : Form
    {
        Datos.Conexiondbo conexion = new Datos.Conexiondbo();
        public frmCargaDeDatosActualizacionDeBanco()
        {
            InitializeComponent();
        }
        ...
        private void frmCargaDeDatosActualizacionDeBanco_Load(object sender, EventArgs e)
        {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand comando = new SqlCommand("sp_insertar_actualizar_banco_num", conexion.conexionBD());
