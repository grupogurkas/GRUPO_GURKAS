...
namespace pl_Gurkas.ExportacionExcel.RRHH
{
    class ExportarDataExcelRRHH
    {
        ...
        public void ExportarDatosPersonalActivo(DataGridView dgView, ProgressBar pBar,string empresa)
        {
            try
            {
                SaveFileDialog fichero = new SaveFileDialog();
                fichero.Filter = "Excel (*.xls)|*.xls";
                fichero.FileName = "Personal Activo "+ empresa;
                if (fichero.ShowDialog() == DialogResult.OK)
                {
                    if (pBar != null)
                    {
        ...
        public void ExportarDatosBarraGeneral(DataGridView dgView, ProgressBar pBar)
        {
            try
            {
                SaveFileDialog fichero = new SaveFileDialog();
