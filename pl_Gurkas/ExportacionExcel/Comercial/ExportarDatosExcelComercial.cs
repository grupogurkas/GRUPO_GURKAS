...
namespace pl_Gurkas.ExportacionExcel.Comercial
{
    class ExportarDatosExcelComercial
    {
        public void ExportarDatosExcelAsistenciaPersonalComercial(DataGridView dgView, ProgressBar pBar, string nombre_unidad, string fi, string ff)
        {
            try
            {
        ...
        public void ExportarDatosExcelAsistenciaPersonalDetalladoComercial(DataGridView dgView, ProgressBar pBar, string nombre_unidad, string fi, string ff)
        {
            try
            {
                SaveFileDialog fichero = new SaveFileDialog();
