...
namespace pl_Gurkas.ExportacionExcel.CentroControl
{
    class ExportarDatosExcelCentroControl
    {
        public void ExportarDatosExcelAsistenciaPersonal(DataGridView dgView, ProgressBar pBar, string nombre_unidad, string fi, string ff)
        {
            try
            {
                SaveFileDialog fichero = new SaveFileDialog();
                fichero.Filter = "Excel (*.xls)|*.xls";
                fichero.FileName = "Resumen de Asistencia de la unidad " + nombre_unidad + " Fecha " + fi + " al " +ff;
                if (fichero.ShowDialog() == DialogResult.OK)
                {
                    ...
                    foreach (DataGridViewRow fila in dgView.Rows) //Aquí leemos las filas de las columnas leídas
                    {
                        ...
                        foreach (DataGridViewColumn columna in dgView.Columns)
                        {
                            ...
                            formatRange = hoja_trabajo.get_Range("A" + (iFil + 1), "D" + (iFil + 1));
        ...
        public void ExportarDatosExcelAsistenciaPersonalDetallado(DataGridView dgView, ProgressBar pBar, string nombre_unidad, string fi, string ff)
        {
            try
            {
                SaveFileDialog fichero = new SaveFileDialog();
                ...
                if (fichero.ShowDialog() == DialogResult.OK)
                {
                    ...
                    foreach (DataGridViewRow fila in dgView.Rows) //Aquí leemos las filas de las columnas leídas
                    {
                        ...
                        foreach (DataGridViewColumn columna in dgView.Columns)
                        {
                            iCol++;
                            hoja_trabajo.Cells[iFil + 1, iCol] = fila.Cells[columna.Name].Value;
                            formatRange = hoja_trabajo.get_Range("A" + (iFil + 1), "E" + (iFil + 1));
                            formatRange.NumberFormat = "@";
                        }
                        pBar.Value += 1;
                    }
        ...
        public void ExportarDatosExcelPersonalSinMarcacion(DataGridView dgView, ProgressBar pBar, string nombre_unidad, string fi)
        {
            try
            {
                SaveFileDialog fichero = new SaveFileDialog();
                fichero.Filter = "Excel (*.xls)|*.xls";
                fichero.FileName = "Resumen de personal sin marcacion de la unidad " + nombre_unidad + " Fecha " + fi;
                if (fichero.ShowDialog() == DialogResult.OK)
                {
                    if (pBar != null)
                    {
        ...
        public void ExportarDatosExcelPersonalAsistencaPorDia(DataGridView dgView, ProgressBar pBar, string nombre_unidad, string fi)
        {
            try
            {
                SaveFileDialog fichero = new SaveFileDialog();
                fichero.Filter = "Excel (*.xls)|*.xls";
                fichero.FileName = "Resumen de asistencia por dia la unidad " + nombre_unidad + " Fecha " + fi;
                if (fichero.ShowDialog() == DialogResult.OK)
                {
                    if (pBar != null)
                    {
        ...
        public void ExportarDatosExcelAsistenciaDetalladoEmpleado(DataGridView dgView, ProgressBar pBar, string nombre_empleado, string fi, string ff)
        {
            try
            {
                SaveFileDialog fichero = new SaveFileDialog();
