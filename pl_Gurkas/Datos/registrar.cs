...
namespace pl_Gurkas.Datos
{
    class registrar
    {
                                        ...
                                        string numero_certificado, DateTime fechaOtorgamiento, DateTime fechaCaducidad, string pdfbasc, string pdfotro)
        {
            ...
            cmd.Parameters.AddWithValue("@nomb_proveedor", SqlDbType.VarChar).Value = Nombre;
            ...
            cmd.Parameters.AddWithValue("@correo", SqlDbType.VarChar).Value = Correo;
            cmd.Parameters.AddWithValue("@correo2", SqlDbType.VarChar).Value = Correo2;
            ...
            cmd.Parameters.AddWithValue("@rubro", SqlDbType.VarChar).Value = rubro;
            cmd.Parameters.AddWithValue("@nomb_contacto", SqlDbType.VarChar).Value = NombreContacto;
            cmd.Parameters.AddWithValue("@tipo_proveedor", SqlDbType.Int).Value = Tipoproveedor;
            cmd.Parameters.AddWithValue("@representante", SqlDbType.VarChar).Value = Representante;
            cmd.Parameters.AddWithValue("@tipo_documento", SqlDbType.Int).Value = tipoDoc;
            cmd.Parameters.AddWithValue("@numb_documento", SqlDbType.VarChar).Value = numDoc;
            ...
            cmd.Parameters.AddWithValue("@tipo_empresa", SqlDbType.Int).Value = tipoEmpresa;
            cmd.Parameters.AddWithValue("@estado_proveedor", SqlDbType.Int).Value = Estado;
            cmd.Parameters.AddWithValue("@basc", SqlDbType.Int).Value = basc;
            cmd.Parameters.AddWithValue("@no_basc", SqlDbType.Int).Value = no_basc;
            cmd.Parameters.AddWithValue("@autenticidad", SqlDbType.VarChar).Value = autenticidad;
     ...
     string codSede, string tipoasistencia)
       ...
       string hijo2, string dni2, string hijo3, string dni3, string hijo4, string dni4,int cantidad_hijos)
        ...
        public void RegistrarReclamo(string numticke, string fecha, string marcacion, string unidad, string sede, string nombre,
                  string mensaje,int estado, string cod_empleado, string observacion)
        {
            // SqlCommand cmd = new SqlCommand("SP_insertarHitoricoPlanilla ", conexion.ConexionBD());
            SqlCommand cmd = new SqlCommand("sp_insertar_reclamo ", conexion.conexionBD());
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@id_reclamo_mysql", SqlDbType.VarChar).Value = numticke;
            cmd.Parameters.AddWithValue("@fecha", SqlDbType.VarChar).Value = fecha;
            cmd.Parameters.AddWithValue("@Marcacion", SqlDbType.VarChar).Value = marcacion;
            cmd.Parameters.AddWithValue("@unidad", SqlDbType.VarChar).Value = unidad;
            cmd.Parameters.AddWithValue("@sede", SqlDbType.VarChar).Value = sede;
            cmd.Parameters.AddWithValue("@nombre", SqlDbType.VarChar).Value = nombre;
            cmd.Parameters.AddWithValue("@comentario", SqlDbType.VarChar).Value = mensaje;
            cmd.Parameters.AddWithValue("@cod_empleado", SqlDbType.VarChar).Value = cod_empleado;
            cmd.Parameters.AddWithValue("@onbservacion", SqlDbType.VarChar).Value = observacion;
            cmd.Parameters.AddWithValue("@id_tikects", SqlDbType.Int).Value = estado;
            cmd.ExecuteNonQuery();
        }
